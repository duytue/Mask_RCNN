...
class CityPersonDataset(utils.Dataset):
    def load_coco(self, dataset_dir, subset, class_ids=None,
                  class_map=None, return_coco=False):

        coco = COCO("{}/annotations_cityperson_combined/instancesonly_gtFine_{}.json".format(dataset_dir, subset))

        image_dir = "{}/leftImg8bit_trainvaltest_coco/{}".format(dataset_dir, subset)
    ...
    def load_mask(self, image_id):
        ...
        if image_info["source"] != "coco":
            return super(CityPersonDataset, self).load_mask(image_id)
